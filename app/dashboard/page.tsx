        ...
        <main style={{ flex: 1, padding: '30px 32px 36px' }}>
          <section
            style={{
              ...
              padding: 24,
              display: 'grid',
              gridTemplateColumns: '1.2fr minmax(240px, 0.8fr)',
              gap: 20,
              marginBottom: 20,
            }}
          >
            ...
            >
              <div style={{ position: 'absolute', inset: 0, display: 'grid', placeItems: 'center' }}>
                <div style={{ textAlign: 'center', color: '#fff' }}>
                  ...
                  <p style={{ margin: '8px 0 0', fontSize: 13, opacity: 0.86 }}>
                    AI Concierge Image Placeholder
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ marginTop: 14, display: 'grid', gridTemplateColumns: '1.4fr minmax(240px, 0.8fr)', gap: 14 }}>
            <article
              style={{
                borderRadius: 14,
                border: '1px solid #e5e7eb',
